...
const scrollArrowContainer = document.querySelector('.absolute-container');
const scrollArrow = document.querySelector('.scroll-arrow');
const scrollArrowIcon = document.querySelector('.scroll-arrow i');
...
function toggleScrollArrow() {
  if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
    scrollArrowContainer.classList.add('show-arrow');
  } else {
    scrollArrowContainer.classList.remove('show-arrow');
  }
}
...
scrollArrowIcon.addEventListener('click', () => {
  window.scrollTo(0, 0);
});
