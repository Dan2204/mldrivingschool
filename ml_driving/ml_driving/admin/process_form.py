...
def format_contact_form(form):
  ...
  email_to_2 = "matt@mldrivingschool.co.uk"
  ...
  body_auth = f'<br/><p><a href="https://www.mldrivingschool.co.uk/admin/contacts" style="color: #ff0000">Log in to admin to view contact</a></p>'
  body_footer = "<br/><p>This message is automated, please don't respond</p>"
  
  return Mail(
    from_email='dan.lucas2204@gmail.com',
    # to_emails=email_to_1,
    to_emails=[To(email_to_1), To(email_to_2)],
    is_multiple=True,
...
def format_review_form(form):
  ...
  body_auth = f'<br/><p><a href="https://www.mldrivingschool.co.uk/admin/reviews" style="color: #ff0000">Log in to Admin to approve</a></p>'
  body_footer = "<br/><p>This message is automated, please don't respond</p>"
